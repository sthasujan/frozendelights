...
const Hero = () => {
  ...
  return (
    <div id='hero' className='w-full bf-cover bf-center' style={{backgroundImage: `url(${herobanner})`}}>
      <div className='lg:w-[80%] w-[90%] m-auto lg:h-[800px] lg:py-[0px] py-[40px] h-fit flex flex-col justify-center lg:items-start items-center gap-6'>
        <h1 className='lg:text-[80px] text-[60px] font-Lobster text-red-600 font-semibold leading-[70px]' data-aos="zoom-in"
        data-aos-delay="200">Ice Cream & Frozen Yogurt Shop</h1>
        <h1 className='text-[30px] uppercase' data-aos="zoom-in"
        data-aos-delay="400">Ice Cream Shop</h1>
        <div className='grid lg:grid-cols-3 grid-cols-1 gap-3 lg:w-[60%]
        w-full mt-3' data-aos="slide-up" data-aos-delay="500">
